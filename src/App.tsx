          ...
          <div className="bg-white p-4 rounded-2xl shadow-card border border-stone-200/70 mt-4 no-print">
            ...
            <div className="flex flex-col gap-1.5">
              {/* The regulation the whole app quotes — every (i) hint cites a
                  section of it — so it leads the list. Still a .docx: it is
                  what the RC-Präsidium writes and hands out. */}
              <a href={`${import.meta.env.BASE_URL}docs/Infoschreiben-RC-Wesen-2026-27.docx`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-red-700 hover:text-red-800 hover:underline w-fit"><Download size={14} /> {formData.lang === 'DE' ? 'Infoschreiben RC-Wesen 26/27 (DOCX)' : 'RC information sheet 26/27 (DOCX)'}</a>
        ...
        <div onClick={() => setShowInfoModal(false)} className="fixed inset-0 bg-stone-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 no-print">
          <div onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-5">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a href={`${import.meta.env.BASE_URL}docs/Infoschreiben-RC-Wesen-2026-27.docx`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-red-700 hover:underline"><Download size={15} /> {formData.lang === 'DE' ? 'Infoschreiben RC-Wesen 26/27 (DOCX)' : 'RC information sheet 26/27 (DOCX)'}</a>
