...
export const STAT_STR = {
  DE: {
    ...
    methodLines: [
      ...
      'Noten auf der Skala E− = 1 … C = 8 … A+ = 15; ein Durchschnitt aus weniger als 3 Beobachtungen ist hohl gezeichnet und trägt sein n.',
  ...
  EN: {
    ...
    methodLines: [
      ...
      'Grades on the scale E− = 1 … C = 8 … A+ = 15; an average from fewer than 3 observations is drawn hollow and carries its n.',
